 ...
 *
 * Uses the new DestinationSearch component with a transparent input style
 * that blends into the hero glassmorphism container.
 *
 * Props:
 *  - onDestinationSelect(locationData) — called when a destination is selected.
 */
export function DestinationHeroInput({ onDestinationSelect }) {
  ...
  const POPULAR_DESTINATIONS = [
    ...
    { name: 'Bali', display: 'Bali, Indonesia' },
  ];
